SAFEZONE = {
    ...
    messages = {
        prefix = "[SafeZone] ",
        messageStart = "The event will start now with %d participants! Good luck!",
        messageNoStart = "The event was not started due to lack of participants!",
        messageTime = "The event was finished for exceeding the time limit!",
        messageOpen = "The event has been opened, you have %d minutes to enter the event portal located in the temple!",
        messageWait = "The teleport to the event is open, you have %d minute(s) to enter!",
        messageFinish = "The event has finished and the winner was %s! Congratulations!",
        messageWinner = "You won %d %s as a prize for the first place!",
    },
    lifeColor = {
        [1] = 94, -- red
        [2] = 77, -- orange
