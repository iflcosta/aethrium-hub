function onStartup()
	...
	db.query("UPDATE `boss_room` SET `guid_player` = -1, `time` = 0, `to_time` = 0")
	db.query("UPDATE `exclusive_hunts` SET `guid_player` = 0, `time` = 0, `to_time` = 0")
	
    -- House Furniture Table
    db.query([[CREATE TABLE IF NOT EXISTS house_furniture (
