...
local voices = { {text = "Runas, varinhas, poções de vida e de mana! Venha dar uma olhada!"} }
...
shopModule:addBuyableItem({'ultimate mana'}, 26029, 310, 1, 'ultimate health potion')
