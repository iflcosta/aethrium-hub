...
import { Database, Search, FileText, CheckCircle2, Loader2, RefreshCcw } from "lucide-react";
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-white uppercase tracking-tight">
                  {activeProject?.displayName ?? projectSlug}
                </h3>
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-purple-500/10 text-purple-400 font-mono border border-purple-500/20">
                    {projectSlug}
                  </span>
        ...
        <div className="bg-[#0d0d0d] border border-[#222] rounded-xl p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[9px] text-[#444]">Agente: <span className="text-teal-400">Rafael</span></div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[9px] text-[#444]">Agente: <span className="text-blue-400">Viktor</span></div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[9px] text-[#444]">Agente: <span className="text-purple-400">Carlos / Rafael</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-[#222]">
            <div className="bg-purple-500/5 rounded-lg p-4 border border-purple-500/10">
              <h4 className="text-[11px] font-bold text-purple-400 mb-1">Como funciona</h4>
              <p className="text-[11px] text-[#666] leading-relaxed">
                Os arquivos do projeto são divididos em pedaços de 1500 caracteres e indexados no Pinecone.
                Quando um agente recebe uma tarefa, ele consulta os chunks mais relevantes antes de responder.
              </p>
            </div>
          </div>
        </div>
